...
button_ac = Button(root, text="AC", padx=25, pady=15, command=button_aclear)
...
button_dot = Button(root, text=".", padx=31, pady=15, command=lambda: button_click("."))
button_equal = Button(root, text="=", padx=29, pady=15, command=button_equal)
